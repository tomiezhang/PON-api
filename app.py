...
def opera(token_id):
    ...
    if token_id < TOTAL:
        ...
        image_url = _compose_image(['static/background/{}.jpg'.format(background),'static/ear/{}.png'.format(ear),'static/face/{}.png'.format(face),'static/mouth/{}.png'.format(mouth),'static/nose/{}.png'.format(nose),'static/eye/{}.png'.format(eye)],token_id)
        attributes = []
